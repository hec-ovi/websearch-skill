...
under-counts dense code/Markdown. Lowering ``chars_per_token`` (e.g. to 3.5 for Claude)
biases the estimate upward so the progressive-disclosure gate errs toward keeping
content inline.
"""
